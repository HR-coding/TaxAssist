...
6. NOTIFICATIONS:
   ...
   - Email bodies must be plain, human-readable text. NEVER put internal field
     keys/attribute paths (e.g. "taxes_paid.tds_on_salary"), JSON, or any code-shaped
     content in an email — describe values in words (e.g. "TDS deducted on salary:
     Rs 2,14,500"). The recipient must never see anything about the codebase.
