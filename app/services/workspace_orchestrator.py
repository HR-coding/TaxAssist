...
from app.utils.google_auth import get_drive_service, get_gmail_service, get_calendar_service
from app.services.db import db
from app.services.copywriter import generate_channel_copy
...
def _handle_new_file(service, user_id: str, drive_file: dict):
    ...
    if mime_type == "application/pdf" or filename.lower().endswith(".pdf"):
        try:
            from app.tools.ocr_extractor import extract_financial_data
